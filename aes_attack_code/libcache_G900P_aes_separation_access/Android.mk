...
LOCAL_MODULE := libcache_shared
LOCAL_MODULE_FILENAME := libcache

LOCAL_CFLAGS += ${CFLAGS}

LOCAL_SRC_FILES := $(wildcard libcache/*.c)
LOCAL_SRC_FILES += $(wildcard libcache/eviction/*.c)

ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
LOCAL_SRC_FILES += $(wildcard libcache/armv7/*.c)
LOCAL_CFLAGS += -D__ARM_ARCH_7A__
USE_EVICTION = 1
endif
ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
LOCAL_SRC_FILES += $(wildcard libcache/armv8/*.c)
