...
LIBCACHE_VERSION_MAJOR = 0
LIBCACHE_VERSION_MINOR = 0
LIBCACHE_VERSION_REV   = 1

VERSION = ${LIBCACHE_VERSION_MAJOR}.${LIBCACHE_VERSION_MINOR}.${LIBCACHE_VERSION_REV}

# If the API changes, the API version and the ABI version have to be bumped.
LIBCACHE_VERSION_API = 1

# If the ABI breaks for any reason, this has to be bumped.
LIBCACHE_VERSION_ABI = 1
