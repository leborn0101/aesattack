...
{
  size_t* times = calloc(runs, sizeof(size_t));
  if (times == NULL) {
    fprintf(stderr, "Error: Could not allocate memory for times.\n");
    return -1;
  }
