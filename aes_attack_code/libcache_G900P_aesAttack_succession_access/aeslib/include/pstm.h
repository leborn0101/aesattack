...
extern int32_t pstm_exptmod_s(psPool_t *pool, const pstm_int *G, const pstm_int *X,
	const pstm_int *P, pstm_int *Y, int *counter);
...
extern int32_t pstm_montgomery_reduce_s(psPool_t *pool, pstm_int *a, const pstm_int *m,
	pstm_digit mp, pstm_digit *paD, uint16_t paDlen, int *counter, int bits, int MAXBits);
